...
class TaxReportReportController extends GetxController {
  ...
  final RxList<Map<String, dynamic>> taxReport = <Map<String, dynamic>>[].obs;

  Future<List<Map<String, dynamic>>> fetchAllTaxReport() async {
    try {
      ...
      if (jsonResponse["data"] != null) {
        ...
        taxReport.clear();
        taxReport.addAll(data.map((item) {
          return {
