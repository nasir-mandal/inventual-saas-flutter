...
import 'package:inventual/src/presentation/screens/category/update_category_screen.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => _controller.allCategoryLoading.value
                ? const SizedBox()
                : Text(
                    "All Category",
            ...
            Obx(() => _controller.allCategoryLoading.value
                ...
                : _controller.allCategoryList.isEmpty
                    ? const NotFound()
                    : Expanded(
                        child: ListView.separated(
                          itemCount: _controller.allCategoryList.length,
                          ...
                          itemBuilder: (context, index) {
                            var category = _controller.allCategoryList[index];
                            return ListTile(
                              contentPadding:
