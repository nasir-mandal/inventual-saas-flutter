...
class PurchaseBillsSection extends StatefulWidget {
  final dynamic product;

  const PurchaseBillsSection({super.key, required this.product});

  @override
  State<PurchaseBillsSection> createState() => _PurchaseBillsSectionState();
}

class _PurchaseBillsSectionState extends State<PurchaseBillsSection> {
  final CreatePurchaseController _createController = CreatePurchaseController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PreferredSize(
          ...
          child: CustomAppBar(navigateName: "Purchase Bills")),
      body: Container(
            ...
            Padding(
              ...
              child: CustomDropdownField(
                  ...
                  dropdownItems: purchaseStatusData
                      ...
                      .toList(),
                  onSelectedValueChanged: (value) {
                    _createController.purchaseStatusValue.value = value;
                    _createController.purchaseStatusID.value =
                        purchaseStatusData
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  buildElevatedButton(
                      "Save Purchase", ColorSchema.success.withOpacity(0.7)),
                ],
              ),
            ),
            const SizedBox(
      ...
      onPressed: () {
        if (buttonName == "Reset") {
          ...
          if (_createController.wareHouseID.value == 0 ||
              _createController.supplierID.value == 0 ||
              _createController.purchaseStatusID.value == 0) {
            Get.snackbar(
              "Error",
