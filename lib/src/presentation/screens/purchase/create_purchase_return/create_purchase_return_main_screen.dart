...
import 'package:inventual_saas/src/presentation/screens/purchase/create_purchase_return/purchase_return_bills.dart';
...
class CreatePurchaseReturnMainScreen extends StatefulWidget {
  const CreatePurchaseReturnMainScreen({Key? key}) : super(key: key);

  @override
  State<CreatePurchaseReturnMainScreen> createState() =>
      _CreatePurchaseReturnMainScreenState();
}

class _CreatePurchaseReturnMainScreenState
    extends State<CreatePurchaseReturnMainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const PreferredSize(
        ...
        child: CustomAppBar(
          navigateName: "Create Purchase Return",
        ),
      ),
      body: Container(
          ...
          children: [
            ...
            Obx(
              () => filteredProducts.isEmpty
                  ? const SizedBox()
                  : Text(
                      "Select Items For Return Purchase ",
              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PurchaseReturnBillsSection(
