...
class NewSalesMainScreen extends StatefulWidget {
  const NewSalesMainScreen({super.key});

  @override
  State<NewSalesMainScreen> createState() => _NewSalesMainScreenState();
}

class _NewSalesMainScreenState extends State<NewSalesMainScreen> {
              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SalesBillsSection(product: selectedItems)));
                },
                label: Text(
                  "Go Sales Bills",
                  style: GoogleFonts.raleway(
