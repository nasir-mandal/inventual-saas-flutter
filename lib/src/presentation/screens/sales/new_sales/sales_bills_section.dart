...
import 'package:inventual_saas/src/business_logic/pos_sale/create_payment_controller.dart';
import 'package:inventual_saas/src/business_logic/pos_sale/create_sale.dart';
...
class SalesBillsSection extends StatefulWidget {
  final dynamic product;

  const SalesBillsSection({super.key, required this.product});

  @override
  State<SalesBillsSection> createState() => _PosBillsSectionState();
}

class _PosBillsSectionState extends State<SalesBillsSection> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const PreferredSize(
          ...
          child: CustomAppBar(navigateName: "Sales Bills")),
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Padding(
              ...
              child: buildOptionalInputTextField("Sales Note",
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: buildOptionalInputTextField("Staff Remark",
                  TextInputType.text, _createController.remark.value),
            ),
            const SizedBox(
              height: 20,
            ),
            ...
            Padding(
              ...
              child: CustomDropdownField(
                  ...
                  dropdownItems: saleStatus
                      .map((item) => item["title"] as String)
                      .toList(),
                  onSelectedValueChanged: (value) {
                    _createController.saleStatusValue.value = value;
                    _createController.saleStatusID.value = saleStatus
                        .firstWhere((item) => item["title"] == value)["id"];
                  }),
            ),
            const SizedBox(
            ...
            Padding(
              ...
              child: CustomDropdownField(
                  ...
                  dropdownItems: paymentStatus
                      .map((item) => item["title"] as String)
                      .toList(),
                  onSelectedValueChanged: (value) {
                    _createController.paymentStatusValue.value = value;
                    _createController.paymentStatusID.value = paymentStatus
                        .firstWhere((item) => item["title"] == value)["id"];
                  }),
            ),
            const SizedBox(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  buildElevatedButton("Save Sale", ColorSchema.analyticsColor2),
                ],
              ),
            ),
            const SizedBox(
              ...
              child: ListView(
                children: [
                  ...
                  Obx(() => TextFieldSection(
                      hint:
                          "Payable Amount ${_createController.payableAmount.value.toString()}",
                  ...
                  Obx(() {
                    if (createPaymentController.change.value > 0) {
                      return TextFieldSection(
                        hint:
                            "Change Amount ${createPaymentController.change.value.toString()}",
                        inputType: TextInputType.number,
                      );
                    } else {
                      return TextFieldSection(
                        hint:
                            "Due Amount ${createPaymentController.due.value.toString()}",
                        inputType: TextInputType.number,
                      );
                    }
                  }),
                  ...
                  buildOptionalInputTextField("Sale Note", TextInputType.number,
