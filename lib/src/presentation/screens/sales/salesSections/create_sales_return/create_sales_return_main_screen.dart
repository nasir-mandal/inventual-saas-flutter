...
import 'package:inventual_saas/src/presentation/screens/sales/salesSections/create_sales_return/sales_return_bills.dart';
...
class CreateSalesReturnMainScreen extends StatefulWidget {
  const CreateSalesReturnMainScreen({Key? key}) : super(key: key);

  @override
  State<CreateSalesReturnMainScreen> createState() =>
      _CreatePurchaseReturnMainScreenState();
}

class _CreatePurchaseReturnMainScreenState
    extends State<CreateSalesReturnMainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const PreferredSize(
        ...
        child: CustomAppBar(
          navigateName: "Create Sales Return",
        ),
      ),
      body: Container(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  buildElevatedButton("Category", ColorSchema.primaryColor),
                  buildElevatedButton("Brand", ColorSchema.analyticsColor2),
                  buildElevatedButton("Featured", ColorSchema.analyticsColor1),
                ],
              ),
            ),
            const SizedBox(
              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SalesReturnBillsSection(product: selectedItems)));
                },
                label: Text(
                  "Go Billing",
                  style: GoogleFonts.raleway(
